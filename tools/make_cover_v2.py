...
d.text((M + 8, y), "VOL. I, No. 2", font=dl, fill=INK)
d.text((W / 2, y), "GENTLE RAPIDS, OHIO — WEDNESDAY, JUNE 17, 2026", font=dl, fill=INK, anchor="ma")
...
lead_lines = ["TOWN ADMIRES FOOTBRIDGE", "AT LAST; STRUCTURE SAID", "TO BE \"DOING ITS BEST\""]
max_w = W - 2 * M - 24
size = 88
while size > 40:
...
for line in ['Council Votes It "Still Charming" by Wide Margin — Harold Knapp,',
             'Vindicated, Admires It Twice More for the Record']:
...
line1 = "MILDRED VANCE ANSWERS EVERYTHING"
lw = d.textlength(line1, font=t_big)
x0 = W / 2 - lw / 2
d.text((x0, y), line1, font=t_big, fill=INK)
chaos_x = x0 + d.textlength("MILDRED VANCE ANSWERS ", font=t_big)
chaos_w = d.textlength("EVERYTHING", font=t_big)
# red strike through CHAOS
d.line([chaos_x - 6, y + 34, chaos_x + chaos_w + 6, y + 27], fill=RED, width=6)
# handwritten correction
cv = caveat(52, 700)
d.text((chaos_x + chaos_w / 2, y - 44), "everything!", font=cv, fill=RED, anchor="ma")
y += 64
y = center(d, y, "Sound Counsel This Week  ·  She Has Opinions, and They Are Hers  ·  Page 12", t_small) + 30
...
y = teaser(y, "MAN FINISHES SECOND BOOK", "Eustace Crabwell Returns It On Time; Town Unsure How to React  ·  Page 6")
y = teaser(y, "THE REGINALD QUESTION", "Our Duck, Our Ghost, One Name  ·  B. Quill, Esq., Page 9")

hrule(d, M + 160, W - M - 160, y, 2); diamond(d, W / 2, y + 1, 10); y += 28
y = center(d, y, "INSIDE: Pelican Fact No. 2 (Page 6, As Negotiated)  ·  More Stupid Poems  ·  A Cow Update", t_small) + 8
y = center(d, y, "PERSONALS: Still Weird, Still Lonely, Still Welcome  ·  See the Back Pages", t_small) + 8
...
img.save("/home/claude/register/images/vol1no2-cover.png", optimize=True)
