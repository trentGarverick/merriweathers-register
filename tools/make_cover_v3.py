...
d.text((M + 8, y), "VOL. I, No. 3", font=dl, fill=INK)
d.text((W / 2, y), "GENTLE RAPIDS, OHIO — WEDNESDAY, JUNE 24, 2026", font=dl, fill=INK, anchor="ma")
...
lead_lines = ["TOWN VOTES TO KEEP THE", "WOBBLE; BENCH DECLARED", "“LOAD-BEARING” BY COUNCIL"]
max_w = W - 2 * M - 24
size = 88
while size > 40:
...
for line in ['Repair Rejected 7-0 After Nine Residents Testify That They Like It —',
             'Carpenter Sent Home With Pie and Full Payment']:
...
line1 = "BEES FILE FIRST COMPLAINT"
lw = d.textlength(line1, font=t_big)
x0 = W / 2 - lw / 2
d.text((x0, y), line1, font=t_big, fill=INK)
chaos_x = x0 + d.textlength("BEES FILE FIRST ", font=t_big)
chaos_w = d.textlength("COMPLAINT", font=t_big)
# red strike through CHAOS
d.line([chaos_x - 6, y + 34, chaos_x + chaos_w + 6, y + 27], fill=RED, width=6)
# handwritten correction
cv = caveat(52, 700)
d.text((chaos_x + chaos_w / 2, y - 44), "report!", font=cv, fill=RED, anchor="ma")
y += 64
y = center(d, y, "Downstairs Sends a Note After 39 Years; It Is Very Polite  ·  Page 6", t_small) + 30
...
y = teaser(y, "BUNKLE ANSWERS HISTORICALLY", "Sound Counsel  ·  Every Problem Has Happened Before  ·  Page 12")
y = teaser(y, "THE GOOSE, TRANSCRIBED", "Thirty-One Minutes, Eleven Days of Labor  ·  B. Quill, Esq., Page 9")

hrule(d, M + 160, W - M - 160, y, 2); diamond(d, W / 2, y + 1, 10); y += 28
y = center(d, y, "INSIDE: Pelican Fact No. 3 (Page 6, As Negotiated)  ·  A Third Poem  ·  The Whistle Hums", t_small) + 8
y = center(d, y, "PERSONALS: The Rowboat Keeps the Schedule  ·  See the Back Pages", t_small) + 8
...
img.save("/home/claude/register/images/vol1no3-cover.png", optimize=True)
